...
public class BankAccountTester {
    public static void main(String[] args) {
        ...
        BankAccount yourAccount = new BankAccount("Katara", 1234567, 10000, 0,
         101, "01/01/2000");

        System.out.println(yourAccount.name);

        System.out.println(yourAccount.getbalance());
        System.out.println(yourAccount.getbalanceSavings());
        ...
        System.out.println(myAccount.getbalanceSavings());
