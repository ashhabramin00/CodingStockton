 ...
 * private Balance Savings -> double ✓
...
public class BankAccount {
    ...
    // Bank Account Constructor
    public BankAccount(String name, int ssn, double balanceChecking, double balanceSavings,
     int accountNumber, String dob) {
        this.name = name;
        this.ssn = ssn;
     ...
     */
    public void setbalanceChecking(double balance) {
        this.balanceChecking = balance;
    }

    public void setbalanceSavings(double balance) {
        this.balanceSavings = balance;
    }
    ...
    public void printBalance() {
        System.out.println("Your balance in checking is: $" + this.balanceChecking);
    }
    public void printBalanceSavings() {
        System.out.println("Your balance in savings is: $" + this.balanceSavings);
    }
    ...
    public static void interact(BankAccount account) {
        ...
        if (choice == 1) {
            ...
            if (account.getbalance() < 0) {
                ...
                System.out.println("$35 dollar fee will be applied");
                // remove -$35 fee
                account.withdraw(35);
                account.printBalance();
            }
    ...
    public void simpleInterest(double principal, int time, double rate) {
        ...
        System.out.println("Current Rate is: " + rate + "%");
        System.out.println("Selected Time is: " + time + " years");
        System.out.println("Simple Interest after " + time + " years is: $" + compinterest);
        System.out.println("Total Amount after " + time + " years is: $" + roundedAmount);
    }
